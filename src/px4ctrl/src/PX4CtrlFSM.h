...
public:
	...
	PX4CtrlFSM(Parameter_t &, Controller &, const ros::NodeHandle &);
	void process();
    ...
    ros::Timer px4ctrl_data_pub_timer_;
    void px4ctrlDataPub();
...
private:
	...
	void reboot_FCU();
    bool toggle_emergency_land();    // try to jump to emergency land mode (use autopilot hardware autonomous land sequence)
