...
namespace ego_planner
{
  ...
  private:
    ...
    double wei_tracking_;                    // target tracking weight
    double wei_visibility_;                  // visibility weight
  ...
  private:
    ...
    bool trackingGradCostP(const Eigen::Vector3d &p, Eigen::Vector3d &gradp, double &costp);
