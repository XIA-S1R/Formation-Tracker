...
(cl:defmethod cl:initialize-instance :after ((m <TargetState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TargetState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tracking_msgs-msg:<TargetState> is deprecated: use tracking_msgs-msg:TargetState instead.")))

(cl:ensure-generic-function 'target_odom-val :lambda-list '(m))
(cl:defmethod target_odom-val ((m <TargetState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracking_msgs-msg:target_odom-val is deprecated.  Use tracking_msgs-msg:target_odom instead.")
  (target_odom m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TargetState>) ostream)
  "Serializes a message object of type '<TargetState>"
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'target_odom) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TargetState>) istream)
  "Deserializes a message object of type '<TargetState>"
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'target_odom) istream)
  msg
)
