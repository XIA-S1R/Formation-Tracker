...
struct ReplanState_
{
  ...
  _state_type state;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _iniState_type;
...
struct MD5Sum< ::quadrotor_msgs::ReplanState_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x38714edcd5022172ULL;
  static const uint64_t static_value2 = 0x624012c3dbfdd606ULL;
};
